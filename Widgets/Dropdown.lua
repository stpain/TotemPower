...
TotemPowerWrathEraWidgetsDropDownTemplateMixin = {}

function TotemPowerWrathEraWidgetsDropDownTemplateMixin:OnLoad()
...
function TotemPowerWrathEraWidgetsDropDownTemplateMixin:SetWidth(width)
    --self.flyout:SetWidth(width)
end

function TotemPowerWrathEraWidgetsDropDownTemplateMixin:SetText(text)
    self.label.text:SetText(text)
end

function TotemPowerWrathEraWidgetsDropDownTemplateMixin:ClearMenu()
    self.flyout.listview.DataProvider:Flush()
end

function TotemPowerWrathEraWidgetsDropDownTemplateMixin:SetMenu(t)
...
TotemPowerWrathEraWidgetsDropDownListviewItemTemplateMixin = {}

function TotemPowerWrathEraWidgetsDropDownListviewItemTemplateMixin:OnLoad()
    self.dropdown = self:GetParent():GetParent():GetParent():GetParent():GetParent()
end

function TotemPowerWrathEraWidgetsDropDownListviewItemTemplateMixin:SetDataBinding(binding, height)
...
function TotemPowerWrathEraWidgetsDropDownListviewItemTemplateMixin:ResetDataBinding()
