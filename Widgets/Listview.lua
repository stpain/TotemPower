TotemPowerWrathEraWidgetsListviewMixin = {}

function TotemPowerWrathEraWidgetsListviewMixin:OnLoad()
...
function TotemPowerWrathEraWidgetsListviewMixin:OnElementInitialize(element, elementData, isNew)
    if isNew then
        element:OnLoad();
    end
    local height = self.elementHeight;
...
function TotemPowerWrathEraWidgetsListviewMixin:OnElementReset(element)
